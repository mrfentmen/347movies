...
| Catalog | ✅ **16 pools** (~72k items in the sitemap): films (15,920), TV (2,514), anime (24), cartoons (1,308), radio (2,309), music (1,455), documentaries (8,417), sports (3,625), shorts (1,858), silents (729), public broadcasting (1,653), science (257), government films (5,947), audiobooks (18,344), vintage records (5,038), ephemeral films (413) — all license-gated at build, fail-closed |
...
| Sitemap | ✅ **72,406 URLs** — a sitemap index (`/sitemap.xml`) pointing at one sub-sitemap per pool (17 files, each under the 50k protocol limit) with `<lastmod>`, canonical self-heals |
...
3. **Search Console** — verify the domain, submit the sitemap index (72,406 URLs across 17 sub-sitemaps).
