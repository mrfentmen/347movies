...
| Catalog | ✅ **14 pools** (~64k items in the sitemap): films (15,920), TV (2,514), anime (24), cartoons (1,308), radio (2,309), music (1,455), documentaries (8,417), sports (3,625), shorts (1,858), silents (729), public broadcasting (1,653), science (257), government films (5,947), audiobooks (18,344) — all license-gated at build, fail-closed |
...
| Sitemap | ✅ **64,088 URLs** (all fourteen pools, deduped) with `<lastmod>`, canonical self-heals |
...
3. **Search Console** — verify the domain, submit the sitemap (64,088 URLs).
