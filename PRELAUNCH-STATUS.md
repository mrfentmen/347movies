# 347movies — Pre-launch status (one page)**Last updated 2026-08-25 after 82 verified deploys.** The site is production-ready within
...
| Catalog | ✅ **22 pools** (~86k items in the sitemap): films (15,920), TV (2,514), anime (24), cartoons (1,308), radio (2,309), music (1,455), documentaries (8,417), TED talks (2,933), sports (3,625), shorts (1,858), silents (729), public broadcasting (1,653), science (257), government films (12,583), audiobooks (18,344), vintage records (5,038), ephemeral films (413), space & NASA (719), vintage footage (445), World War II (2,821), newsreels (595), NFPF orphan films (185) — all license-gated at build, fail-closed |
...
| Sitemap | ✅ **~86k URLs** — a sitemap index (`/sitemap.xml`) pointing at one sub-sitemap per pool (23 files, each under the 50k protocol limit) with `<lastmod>`, canonical self-heals |
...
3. **Search Console** — verify the domain, submit the sitemap index (86,255 URLs across 22 sub-sitemaps).
