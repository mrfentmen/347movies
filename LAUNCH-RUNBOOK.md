...
When Search Console is live, Google will crawl the sitemap index (73,125 URLs across 18 sub-sitemaps, all seventeen pools). What to expect and
...
- [ ] Submit `https://347movies.pages.dev/sitemap.xml` in Search Console and check the
      sitemap report after a few days (expected: 73,125 URLs across the index's sub-sitemaps, no errors).
